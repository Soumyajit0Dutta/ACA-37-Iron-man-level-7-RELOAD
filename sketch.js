...
function draw() {
  if(gamestate=="play"){
    ...
    player.scale=0.3;
    player.setCollider("rectangle", 70, -20, 330, 480);
...
function genreateStones(){
  if (frameCount% 60 == 0){
    ...
    stone.lifetime=250;
    stone.setCollider("rectangle", 0, 0, 213, 50);
  }
}
...
function generateDiamonds(){
  if(frameCount%35 == 0){
     ...
     diamond.setCollider("rectangle", 0, 10, 100, 100);
...
function generateSpikes(){
  if(frameCount%40== 0){
    ...
    spikes.lifetime=250;
    spikes.setCollider("rectangle", 0, 0, 60, 60);
  }
}
